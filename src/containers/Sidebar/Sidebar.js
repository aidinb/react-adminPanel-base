...
@inject('app','themeSwitcher','routing')
@observer
export default class Sidebar extends Component {
    ...
    handleClick = (e) => {
        ...
        app.changeCurrent([e.key]);
        if (app.view === 'MobileView') {
            setTimeout(() => {
                app.toggleCollapsed();
                app.toggleOpenDrawer();
            }, 100);
        }
    }
    ...
    render() {
        ...
        const styling = {
            backgroundColor: themeSwitcher.sidebarTheme.backgroundColor
        };
        const submenuStyle = {
            backgroundColor: 'rgba(0,0,0,0.3)',
            color: themeSwitcher.sidebarTheme.textColor
        };
        const submenuColor = {
            color: themeSwitcher.sidebarTheme.textColor
        };
            ...
            <SidebarWrapper>
                ...
                >
                    ...
                    <Scrollbars
                        ...
                        style={{height: toJS(app.height) - 70}}
                    >
                        <Menu
                            onClick={this.handleClick}
                            theme="dark"
                            mode={mode}
                            openKeys={collapsed ? [] : toJS(app.openKeys)}
                            selectedKeys={toJS(app.current)}
